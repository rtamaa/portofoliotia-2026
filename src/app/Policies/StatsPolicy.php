...
class StatsPolicy
{
    ...
    {
        return $user->can('view_any_stats');
    }
    ...
    {
        return $user->can('delete_any_stats');
    }
     ...
     */
    public function replicate(User $user, Stats $stats): bool
    {
